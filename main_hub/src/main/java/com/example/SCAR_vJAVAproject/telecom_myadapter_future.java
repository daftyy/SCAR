...
public class telecom_myadapter_future extends FirebaseRecyclerAdapter<model, telecom_myadapter_future.myviewholder_other> {
     ...
     * @param options
     */
    public telecom_myadapter_future(@NonNull FirebaseRecyclerOptions<model> options) {
        super(options);
    }
