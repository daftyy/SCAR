...
public class banking_myadapter_future extends FirebaseRecyclerAdapter<model, banking_myadapter_future.myviewholder_other> {
     ...
     * @param options
     */
    public banking_myadapter_future(@NonNull FirebaseRecyclerOptions<model> options) {
        super(options);
    }
