...
public class other_myadapter_past extends FirebaseRecyclerAdapter<model, other_myadapter_past.myviewholder_2_other> {
    CheckBox done;
    String id;
     ...
     * @param options
     */
    public other_myadapter_past(@NonNull FirebaseRecyclerOptions<model> options) {
        super(options);
    }
