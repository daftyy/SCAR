...
public class shopping_myadapter_past extends FirebaseRecyclerAdapter<model, shopping_myadapter_past.myviewholder_2_other> {
    CheckBox done;
    String id;
     ...
     * @param options
     */
    public shopping_myadapter_past(@NonNull FirebaseRecyclerOptions<model> options) {
        super(options);
    }
