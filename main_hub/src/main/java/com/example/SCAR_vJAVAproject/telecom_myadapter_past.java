...
public class telecom_myadapter_past extends FirebaseRecyclerAdapter<model, telecom_myadapter_past.myviewholder_2_other> {
    CheckBox done;
    String id;
     ...
     * @param options
     */
    public telecom_myadapter_past(@NonNull FirebaseRecyclerOptions<model> options) {
        super(options);
    }
