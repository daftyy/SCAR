...
public class other_myadapter_future extends FirebaseRecyclerAdapter<model, other_myadapter_future.myviewholder_other> {
     ...
     * @param options
     */
    public other_myadapter_future(@NonNull FirebaseRecyclerOptions<model> options) {
        super(options);
    }
